...
function buildGeminiAnalysisSystemPrompt(): string {
  return [
    ...
    "  },",
    '  "timelines": {',
    '    "dueDate": string (ISO 8601 format, e.g., "2025-12-03T11:00:00" or "2025-12-03"),',
    '    "publishedDate"?: string (ISO 8601 format),',
    '    "questionsDue"?: string (ISO 8601 format),',
    '    "siteMeeting"?: { "date": string (ISO 8601 format), "time"?: string, "address"?: string, "mandatory"?: boolean }',
    "  },",
    ...
    '  "risks": Array<{ "category": "eligibility"|"bee_compliance"|"financial"|"technical"|"timeline"|"commercial"|"legal"|"administrative", "severity": "low"|"medium"|"high"|"critical", "description": string, "mitigation"?: string, "likelihood"?: number, "impact"?: number }>,',
    ...
    "- Use ISO 8601 date strings for all date/time values (e.g., '2025-12-03T11:00:00' or '2025-12-03'). Do NOT use Unix timestamps.",
    "- Pay careful attention to the YEAR in dates - verify it matches exactly what is written in the document.",
